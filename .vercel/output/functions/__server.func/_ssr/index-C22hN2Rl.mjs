...
import { u as useLanguage } from "./router-56Y4IDAv.mjs";
...
function ServiceSplit() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "services", className: "grid md:grid-cols-2 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, className: "bg-charcoal text-champagne p-10 md:p-20 flex flex-col justify-between min-h-[600px] relative overflow-hidden group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-5", children: barberServices.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: `flex justify-between items-end pt-5 group/item cursor-pointer ${i > 0 ? "border-t border-white/5" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans font-extrabold uppercase text-lg md:text-2xl text-champagne group-hover/item:text-gold group-hover/item:translate-x-1 transition-all", children: s.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-gold text-xs pb-1.5 whitespace-nowrap ml-4", children: s.price })
        ] }, s.name)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mt-12 self-start border border-gold text-gold px-8 py-3.5 font-mono text-[10px] uppercase tracking-[0.25em] hover:bg-gold hover:text-charcoal transition-all", children: t.services.barberMenu })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, className: "bg-rose text-ink p-10 md:p-20 flex flex-col justify-between min-h-[600px] relative overflow-hidden group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-5", children: beautyServices.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: `flex justify-between items-end pt-5 group/item cursor-pointer ${i > 0 ? "border-t border-ink/10" : ""}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans font-extrabold uppercase text-lg md:text-2xl text-ink group-hover/item:text-espresso group-hover/item:translate-x-1 transition-all", children: s.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-espresso text-xs pb-1.5 whitespace-nowrap ml-4", children: s.price })
        ] }, s.name)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mt-12 self-start border border-espresso text-espresso px-8 py-3.5 font-mono text-[10px] uppercase tracking-[0.25em] hover:bg-espresso hover:text-rose transition-all", children: t.services.beautyMenu })
    ] })
  ] });
}
function Team() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "artisans", className: "bg-charcoal py-24 md:py-32 overflow-hidden relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1600px] mx-auto px-6 md:px-10 grid lg:grid-cols-2 gap-16 items-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      duration: 0.8,
      ease: [0.16, 1, 0.3, 1]
    }, className: "w-full max-w-sm group cursor-pointer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[3/4] overflow-hidden mb-6 bg-espresso flex items-center justify-center shadow-2xl border border-white/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-champagne/20 font-display italic text-8xl group-hover:scale-110 transition-transform duration-700", children: "A" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-charcoal/90 via-charcoal/20 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-6 left-6 right-6 flex justify-between items-end", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-widest text-gold bg-charcoal/80 backdrop-blur px-3 py-1.5 border border-gold/20", children: t.team.badge }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "size-12 rounded-full bg-gold text-charcoal flex items-center justify-center text-lg opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all shadow-lg", children: "→" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-4xl text-champagne italic mb-2", children: t.team.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mt-1 border-t border-white/10 pt-3", children: [
