...
import {
  ...
  B as BaseRootRoute,
  a as BaseRoute,
  p as isModuleNotFoundError,
  q as isNotFound,
  l as getScrollRestorationScriptForRouter,
  v as rootRouteId,
  s as isServer,
  r as isRedirect,
  ...
  R as RouterCore,
  g as escapeHtml,
  j as getAssetCrossOrigin,
  k as getScriptPreloadAttrs,
  b as appendUniqueUserTags,
  u as resolveManifestCssLink,
  x as transformReadableStreamWithRouter,
  w as transformPipeableStreamWithRouter,
